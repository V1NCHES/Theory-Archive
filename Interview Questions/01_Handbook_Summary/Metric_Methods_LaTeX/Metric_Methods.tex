...
\subsection{Взвешенный k-NN}

\subsubsection{Веса по рангу (порядковому номеру)}
...
\subsubsection{Веса от расстояния}
...
\subsubsection{Ядерное сглаживание}
...
\subsubsection{Ядерная регрессия (Формула Надарая-Ватсона)}
...
\subsubsection{Оптимизация поиска ближайшего соседа}
