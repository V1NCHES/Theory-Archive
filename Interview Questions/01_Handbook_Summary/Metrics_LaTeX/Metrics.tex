...
\subsubsection{Офлайновые метрики}
...
\subsubsection{Онлайновые метрики}
...
\subsubsection{Ключевые отличия}
\begin{longtable}{@{}lll@{}}
\toprule
...
\subsubsection{Функция потерь (Loss Function)}
...
\subsubsection{Метрика качества (Metric)}
...
\subsubsection{В чем ключевые отличия?}
\begin{enumerate}
...
\subsubsection{Основные метрики качества}
...
\subsection{Кривые и площади: ROC-AUC и PR-AUC}
...
\subsubsection{ROC-AUC (Receiver Operating Characteristic)}
...
\subsubsection{PR-AUC (Precision-Recall Curve)}
Кривая строится в осях:
\begin{itemize}
...
\subsubsection{Относительные метрики: MAPE, SMAPE, WAPE}
